...
function activate(context) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            context.subscriptions.push(leetCodeStatusBarController_1.leetCodeStatusBarController, leetCodeChannel_1.leetCodeChannel, leetCodePreviewProvider_1.leetCodePreviewProvider, leetCodeSubmissionProvider_1.leetCodeSubmissionProvider, leetCodeSolutionProvider_1.leetCodeSolutionProvider, leetCodeExecutor_1.leetCodeExecutor, markdownEngine_1.markdownEngine, CodeLensController_1.codeLensController, explorerNodeManager_1.explorerNodeManager, timer.problemTimer, vscode.window.registerFileDecorationProvider(LeetCodeTreeItemDecorationProvider_1.leetCodeTreeItemDecorationProvider), vscode.window.createTreeView("leetCodeExplorer", { treeDataProvider: LeetCodeTreeDataProvider_1.leetCodeTreeDataProvider, showCollapseAll: true }), vscode.commands.registerCommand("leetcode.deleteCache", () => cache.deleteCache()), vscode.commands.registerCommand("leetcode.toggleLeetCodeCn", () => plugin.switchEndpoint()), vscode.commands.registerCommand("leetcode.signin", () => leetCodeManager_1.leetCodeManager.signIn()), vscode.commands.registerCommand("leetcode.signout", () => leetCodeManager_1.leetCodeManager.signOut()), vscode.commands.registerCommand("leetcode.manageSessions", () => session.manageSessions()), vscode.commands.registerCommand("leetcode.previewProblem", (node) => {
            ...
            }), vscode.commands.registerCommand("leetcode.showProblem", (node) => show.showProblem(node)), vscode.commands.registerCommand("leetcode.pickOne", () => show.pickOne()), vscode.commands.registerCommand("leetcode.searchProblem", () => show.searchProblem()), vscode.commands.registerCommand("leetcode.showSolution", (input) => show.showSolution(input)), vscode.commands.registerCommand("leetcode.uploadSolutionToGitHub", (input) => githubUpload.uploadSolutionToGitHub(input)), vscode.commands.registerCommand("leetcode.uploadSolutionsToGitHubBatch", () => githubUpload.uploadSolutionsToGitHubBatch()), vscode.commands.registerCommand("leetcode.openDebugCases", (uri) => debug.openDebugCases(uri)), vscode.commands.registerCommand("leetcode.debugSolution", (uri) => debug.debugSolution(uri)), vscode.commands.registerCommand("leetcode.showProblemTimer", (uri) => timer.showProblemTimer(uri)), vscode.commands.registerCommand("leetcode.refreshExplorer", () => LeetCodeTreeDataProvider_1.leetCodeTreeDataProvider.refresh()), vscode.commands.registerCommand("leetcode.testSolution", (uri) => {
                trackingUtils_1.default.report({
            ...
            }), vscode.commands.registerCommand("leetcode.testSolutionDirect", (uri) => {
                trackingUtils_1.default.report({
                    event_key: `vscode_runCode`,
                    type: "click",
                    extra: JSON.stringify({
                ...
                return test.testSolutionDirect(uri);

...
function activate(context) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            }), vscode.commands.registerCommand("leetcode.showProblem", (node) => show.showProblem(node)), vscode.commands.registerCommand("leetcode.pickOne", () => show.pickOne()), vscode.commands.registerCommand("leetcode.searchProblem", () => show.searchProblem()), vscode.commands.registerCommand("leetcode.showSolution", (input) => show.showSolution(input)), vscode.commands.registerCommand("leetcode.uploadSolutionToGitHub", (input) => githubUpload.uploadSolutionToGitHub(input)), vscode.commands.registerCommand("leetcode.uploadSolutionsToGitHubBatch", () => githubUpload.uploadSolutionsToGitHubBatch()), vscode.commands.registerCommand("leetcode.openDebugCases", (uri) => debug.openDebugCases(uri)), vscode.commands.registerCommand("leetcode.debugSolution", (uri) => debug.debugSolution(uri)), vscode.commands.registerCommand("leetcode.refreshExplorer", () => LeetCodeTreeDataProvider_1.leetCodeTreeDataProvider.refresh()), vscode.commands.registerCommand("leetcode.testSolution", (uri) => {
                trackingUtils_1.default.report({
